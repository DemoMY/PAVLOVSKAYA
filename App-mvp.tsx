...
import { TaxiModule } from './components/TaxiModule'; // Using original since it doesn't depend on AI
import { LifeModule } from './components/LifeModule-mvp'; // Using MVP version
import { EventsModule } from './components/EventsModule-mvp'; // Using MVP version
import { ChatModule } from './components/ChatModule-mvp'; // Using MVP version
